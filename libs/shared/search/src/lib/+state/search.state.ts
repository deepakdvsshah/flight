...
import { FlightDestination, FlightDestinations, FlightDestinationsService } from '@openapi/flightSearch'
import { catchError, tap } from 'rxjs/operators';
import { HttpClient, HttpHeaders, HttpParams } from '@angular/common/http';


export class FlightSearchStateModel {
    flightList: Array<FlightDestination>;
    flightSearchFail: boolean;
    accessToken: string
}
